...
const Sidebar = () => {
  ...
  return (
    <div role="toolbar" aria-orientation="vertical" dir="ltr" className="dark:bg-customDark-1 dark:border-customDark-2 h-screen border-r-2 border-slate-300 py-5 px-0 dark:text-slate-400" tabIndex="0" data-orientation="vertical">
      <div className='px-4'>
      ...
      <div role="group" dir="ltr" data-orientation="vertical" aria-label="Sidebar" className="mt-8">
        ...
        <div className="transition-border border-b-2 border-t-2 border-slate-300 p-4 duration-700 dark:border-b-2 dark:border-t-2 dark:border-[#23262F]">
