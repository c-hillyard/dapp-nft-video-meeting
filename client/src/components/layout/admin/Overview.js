    ...
    <main className="no-scrollbar h-full w-full overflow-y-auto px-12 pt-9 pb-28">
      <section className="grid h-full w-full grid-cols-4 gap-5 text-white">
        <section className="no-scrollbar h-full overflow-y-auto sm:col-span-4 lg:col-span-3 lg:w-full">
          <section
            className="lg:w-full mb-5 relative z-10 h-fit rounded-2xl border-2 border-transparent bg-white p-4 transition duration-700 dark:border-2 dark:bg-zinc-900">
            <div className="relative z-10 mb-4 flex items-center">
              ...
              <p
                className=" font-500 z-10 text-base leading-6 text-slate-800 transition duration-700 dark:text-slate-300 ">
                Your personal room</p>
            </div>
            <div
            ...
            <div
              className="absolute inset-0 z-0 h-fit w-full rounded-2xl backdrop-blur-3xl transition duration-700 ">
              <svg width="794" height="180" viewBox="0 0 794 180" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_2579_11221)">
                  <g filter="url(#filter0_f_2579_11221)">
                    <circle cx="366.5" cy="229.706" r="87.5961"
                      fill="url(#paint0_linear_2579_11221)"></circle>
                  </g>
                </g>
                <defs>
                  <filter id="filter0_f_2579_11221" x="18.9038" y="-117.89"
                    width="695.192" height="695.192" filterUnits="userSpaceOnUse"
                    colorInterpolationFilters="sRGB">
                    <feFlood floodOpacity="0" result="BackgroundImageFix"></feFlood>
                    <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix"
                      result="shape"></feBlend>
                    <feGaussianBlur stdDeviation="130"
                      result="effect1_foregroundBlur_2579_11221"></feGaussianBlur>
                  </filter>
                  <linearGradient id="paint0_linear_2579_11221" x1="278.904" y1="142.11"
                    x2="454.096" y2="317.302" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#5346FF"></stop>
                    <stop offset="0.447917" stopColor="#6C66FF"></stop>
                    <stop offset="1" stopColor="#538FFF"></stop>
                  </linearGradient>
                  <clipPath id="clip0_2579_11221">
                    <rect width="794" height="180" rx="16" fill="white"></rect>
                  </clipPath>
                </defs>
              </svg></div>
          </section>
          <section
            className="lg:w-full h-fit rounded-2xl border-2 border-transparent bg-white p-4 transition duration-700 dark:border-2 dark:bg-zinc-900">
            ...
            <section className="grid grid-cols-3 gap-4 gap-y-8">
              <div className="undefined  align-center flex justify-evenly rounded-xl border-2 border-slate-200 bg-transparent px-4 py-6  transition duration-700 dark:border-2 dark:border-slate-700">
                <div className="my-1 mr-4 "><svg width="33" height="33" viewBox="0 0 33 33"
              ...
              <div
                className="col-span-2  align-center  flex justify-evenly rounded-xl border-2 border-slate-200 bg-transparent px-4 py-6 transition duration-700 dark:border-2 dark:border-slate-700 ">
          ...
          <div data-orientation="horizontal" className="pb-8">
            <section
              className="dark:bg-zinc-900 mt-4 rounded-2xl bg-white p-4 transition duration-700">
